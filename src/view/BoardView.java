...
public class BoardView extends JFrame
	...
	public void init() {
		...
		Dimension buttonSize = new Dimension(30,30 ); // Adjust the size as needed
		...
		ImageIcon player1Icon = new ImageIcon("1.png");
        lbPlayer_1.setIcon(player1Icon);
		...
		btLeft_1.setPreferredSize(buttonSize);
		...
		btRight_1.setPreferredSize(buttonSize);
		...
		btLeft_2.setPreferredSize(buttonSize);

		panel_4_1.add(btLeft_2);

		btRight_2 = new JButton(">>");
		btRight_2.setEnabled(false);
		btRight_2.setPreferredSize(buttonSize);
		...
		ImageIcon player2Icon = new ImageIcon("2.png");
        lbPlayer_2.setIcon(player2Icon);
